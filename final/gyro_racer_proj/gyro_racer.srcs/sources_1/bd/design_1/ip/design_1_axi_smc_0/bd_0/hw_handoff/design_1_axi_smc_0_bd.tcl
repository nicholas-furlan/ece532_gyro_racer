...
proc create_hier_cell_m01_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b000100} \
   CONFIG.SSC001_ROUTE {0b000001} \
   CONFIG.SSC002_ROUTE {0b000010} \
   CONFIG.SSC003_ROUTE {0b001000} \
   CONFIG.SSC004_ROUTE {0b010000} \
   CONFIG.SSC005_ROUTE {0b100000} \
   CONFIG.SSC006_ROUTE {0b000000} \
   CONFIG.SSC007_ROUTE {0b000000} \
   CONFIG.SSC_ROUTE_WIDTH {6} \
   CONFIG.S_ID_WIDTH {3} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins M01_ACLK] [get_bd_pins aclk1] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M01_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AR_5 [get_bd_intf_pins s04_axi2sc/M_SC_AR] [get_bd_intf_pins s04_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_6 [get_bd_intf_pins s05_axi2sc/M_SC_AR] [get_bd_intf_pins s05_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_7 [get_bd_intf_pins m00_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M00_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_8 [get_bd_intf_pins m01_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M01_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_R_5 [get_bd_intf_pins s04_nodes/S_SC_R] [get_bd_intf_pins switchboards/M04_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_6 [get_bd_intf_pins s05_nodes/S_SC_R] [get_bd_intf_pins switchboards/M05_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_7 [get_bd_intf_pins m00_nodes/S_SC_R] [get_bd_intf_pins m00_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_8 [get_bd_intf_pins m01_nodes/S_SC_R] [get_bd_intf_pins m01_sc2axi/M_SC_R]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins m01_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins s03_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins s05_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins m01_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins s03_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins s05_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
